...
<head>
    ...
    <title>DESAFIO MATRICULAS DE ALUNOS</title>
            ...
            <div class="mt-16">
                <div class="grid grid-cols-1 md:grid-cols-1">
                    <div
                        ...
                        <div>
                            <div
                                class="h-16 w-16 bg-white dark:bg-yellow-800/20 flex items-center justify-center rounded-full">
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Bem-vindo ao Sistema de Matriulas de Alunos! <br>
                                Aqui você poderá acompanhar e gerenciar matriculas.
                            </p>
                        </div>
                    </div>
                </div>
